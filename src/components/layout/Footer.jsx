    ...
    <footer className="bg-slate-800 py-12 px-4 border-t-1 border-slate-700">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="space-y-4 text-center md:text-left lg:col-span-4">
            {/* Logo */}
          ...
          <div className="text-center md:text-left lg:col-span-2">
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Link to="/diseno-chiller" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm no-underline">
                  Diseño Chiller
                </Link>
              </li>
            </ul>
          ...
          <div className="text-center md:text-left lg:col-span-3">
            <h3 className="font-bold text-white mb-3 text-sm">Productos</h3>
            <ul className="space-y-1">
              <li>
                <Link to="/chiller" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm no-underline">
                  Chillers
                </Link>
              </li>
              <li>
            ...
            <h3 className="font-bold text-white mb-3 text-sm mt-6">Cuartos Fríos</h3>
            <ul className="space-y-1">
              <li>
                <Link to="/congelacion" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm no-underline">
                  Congelación
                </Link>
              </li>
              <li>
                <Link to="/conservacion" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm no-underline">
                  Conservación
                </Link>
              </li>
              <li>
          ...
          <div className="text-center md:text-left lg:col-span-3">
            ...
            <ul className="space-y-1">
              <li className="flex items-center justify-center md:justify-start">
                ...
                <span className="text-white text-sm">+57 301 2914925</span>
              </li>
              <li>
                <a 
                  ...
                  className="text-white hover:text-cyan-400 transition-colors duration-300 text-sm no-underline flex items-center justify-center md:justify-start"
                >
            ...
            <ul className="space-y-1 text-gray-300 text-sm">
              <li>Medellín: 3045519390</li>
              <li>Bogotá: 3045519390</li>
              <li>Barranquilla: 3045519390</li>
              <li>Bucaramanga: 3045519390</li>
              <li>Cali: 3045519390</li>
              <li>Pereira: 3045519390</li>
              <li>Fusagasugá: 3045519390</li>
            </ul>
          </div>
        </div>
      </div>
