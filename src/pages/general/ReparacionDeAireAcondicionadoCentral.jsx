...
const ReparacionDeAireAcondicionadoCentral = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Reparacion De Aire Acondicionado Central" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">Reparacion De Aire Acondicionado Central</h1>
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre Reparacion De Aire Acondicionado Central.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Fallas de baja capacidad, vibraciones, fugas, sobreconsumo, fallos eléctricos y drenajes.</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Reparación de fugas y recarga</li>
                    <li>Limpieza de serpentines</li>
                    <li>Cambio de motores y ventiladores</li>
                    <li>Reparación de tableros y sensores</li>
                  </ul>
                </div>
              </div>
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Inspección, limpieza y ajustes</li>
                    <li>Verificación eléctrica y protecciones</li>
                    <li>Mediciones de presiones y vacío</li>
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Servicio técnico con repuestos originales, pruebas de hermeticidad, vacío y carga.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Intervenciones rápidas y efectivas conforme a fabricante.</p>
            </div>
          </div>
        </div>
      </div>
...
export default ReparacionDeAireAcondicionadoCentral;
