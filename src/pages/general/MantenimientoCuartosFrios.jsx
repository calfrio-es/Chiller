...
const MantenimientoCuartosFrios = () => {
  return (
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre MantenimientoCuartosFrios.';
...
export default MantenimientoCuartosFrios;
