...
const ReparacionDeAireAcondicionadoPortatil = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        <div className="absolute inset-0">
          <img src={heroImg} alt="ReparacionDeAireAcondicionadoPortatil" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">ReparacionDeAireAcondicionadoPortatil</h1>
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre ReparacionDeAireAcondicionadoPortatil.';
...
export default ReparacionDeAireAcondicionadoPortatil;
