...
const MantenimientoDeRefrigeracionYAireAcondicionado = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="absolute inset-0">
          <img 
            src={heroImg} 
            alt="MantenimientoDeRefrigeracionYAireAcondicionado" 
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">
            MantenimientoDeRefrigeracionYAireAcondicionado
          </h1>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre MantenimientoDeRefrigeracionYAireAcondicionado.';
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-lg font-semibold text_gray-800 mb-2">Diagnóstico preciso y rápido</h3>
...
export default MantenimientoDeRefrigeracionYAireAcondicionado;
