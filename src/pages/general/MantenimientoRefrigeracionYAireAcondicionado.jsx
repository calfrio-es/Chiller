...
const MantenimientoRefrigeracionYAireAcondicionado = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="absolute inset-0">
          <img 
            src={heroImg} 
            alt="MantenimientoRefrigeracionYAireAcondicionado" 
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">
            MantenimientoRefrigeracionYAireAcondicionado
          </h1>
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">
            Mantenimiento integral para sistemas de refrigeración y aire acondicionado
          </p>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre MantenimientoRefrigeracionYAireAcondicionado.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              ...
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               <div className="text-center mb-6">
                 ...
                 <h3 className="text-2xl font-bold text-gray-800 mb-4">Mantenimiento Integral</h3>
               </div>
               <div className="text-gray-700 space-y-4">
                 <p>
                   Programas preventivos y correctivos para HVAC y refrigeración.
                 </p>
                 <ul className="list-disc list-inside space-y-2 text-sm">
                   <li>Limpieza de serpentines y filtros</li>
                   <li>Revisión eléctrica y mecánica</li>
                   <li>Verificación de presiones y fugas</li>
                   <li>Calibración de controles</li>
                   <li>Optimización de eficiencia energética</li>
                 </ul>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               <div className="text-center mb-6">
                 ...
                 <h3 className="text-2xl font-bold text-gray-800 mb-4">Atención Programada</h3>
               </div>
               <div className="text-gray-700 space-y-4">
                 <p>
                   Calendarios de servicio según criticidad y operación.
                 </p>
                 <ul className="list-disc list-inside space-y-2 text-sm">
                   <li>Planes mensuales, trimestrales y semestrales</li>
                   <li>Reportes y recomendaciones</li>
          ...
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Diseñamos y ejecutamos planes de mantenimiento para equipos de refrigeración y HVAC, priorizando confiabilidad y eficiencia.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Realizamos limpieza de serpentines, revisión de presiones, pruebas de hermeticidad, ajustes eléctricos y calibración de controles.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Mejora el desempeño y reduce el consumo con un mantenimiento planificado y profesional.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-600">Técnicos con instrumentación y protocolos estandarizados.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Experiencia en marcas líderes y equipos industriales.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Mayor durabilidad y garantía del fabricante.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Programación flexible y mínima interrupción operativa.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Ajustes y mejoras para menor consumo.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Respaldo en servicios realizados bajo estándares técnicos.</p>
            </div>
          </div>
        </div>
      </div>
...
export default MantenimientoRefrigeracionYAireAcondicionado;
