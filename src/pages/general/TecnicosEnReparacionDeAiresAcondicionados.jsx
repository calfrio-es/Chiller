...
const TecnicosEnReparacionDeAiresAcondicionados = () => {
  const h1Text = 'Tecnicos En Reparacion De Aires Acondicionados';
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">Especialistas en reparación, mantenimiento e instalación</p>
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Solucionamos fallas comunes y complejas en equipos residenciales y comerciales.</p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Rutinas para evitar fallas, mejorar eficiencia y extender vida útil.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Atención certificada, repuestos originales y garantía por escrito.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Cobertura local y respuesta rápida.</p>
            </div>
          </div>
        </div>
      </div>
...
export default TecnicosEnReparacionDeAiresAcondicionados;
