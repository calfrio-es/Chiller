...
const RepararBobinaCompresorAireAcondicionado = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        <div className="absolute inset-0">
          <img src={heroImg} alt="RepararBobinaCompresorAireAcondicionado" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">RepararBobinaCompresorAireAcondicionado</h1>
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre RepararBobinaCompresorAireAcondicionado.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Reparación de Bobina de Compresor</h3>
                </div>
                <div className="text-gray-700 space-y-4">
                  <p>Diagnóstico y reparación de bobina/embobinado del compresor:</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Pruebas de continuidad y resistencia</li>
                    <li>Reparación o reemplazo de bobina</li>
                    <li>Verificación de consumo y protecciones</li>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Buenas prácticas para el compresor:</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Verificación de voltajes y conexiones</li>
                    <li>Revisión de ventilación</li>
                    <li>Chequeo de protecciones</li>
                    <li>Monitoreo de consumo</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            <div className="mb-8"><h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">Reparación de Bobina de Compresor</h2></div>
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text_gray-700 leading-relaxed mb-6">Restauramos el funcionamiento del compresor mediante pruebas eléctricas y reemplazo de bobina cuando es necesario.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Uso de repuestos originales y validación de protecciones.</p>
            </div>
          </div>
        </div>
      </div>
...
export default RepararBobinaCompresorAireAcondicionado;
