          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre Chiller5ToneladasPrecio.';
...
export default Chiller5ToneladasPrecio;
