...
const ReparacionDeAireAcondicionadoADomicilio = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Reparacion De Aire Acondicionado A Domicilio" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">Reparacion De Aire Acondicionado A Domicilio</h1>
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">Servicio a domicilio para reparación de aire acondicionado</p>
          <div className="flex justify-center mt-8">
            <button
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre Reparacion De Aire Acondicionado A Domicilio.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Atención en sitio para resolver fallas de operación, fugas y problemas eléctricos.</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Reparación de fugas y recarga</li>
                    <li>Limpieza de serpentines y drenajes</li>
                    <li>Cambio de motores y ventiladores</li>
                    <li>Reparación de tarjetas y sensores</li>
                  </ul>
                </div>
              </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            <div className="mb-8"><h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">Reparación de Aire Acondicionado a Domicilio</h2></div>
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Servicio en tu ubicación con estándares técnicos y repuestos originales.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Pruebas de hermeticidad, vacío y carga conforme al fabricante.</p>
            </div>
          </div>
        </div>
      </div>
...
export default ReparacionDeAireAcondicionadoADomicilio;
