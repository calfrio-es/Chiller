...
const SplitAireAcondicionado = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Split Aire Acondicionado" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">Split Aire Acondicionado</h1>
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre Split Aire Acondicionado.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Fallas en equipos tipo split:</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Fugas y reparación de líneas</li>
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Un sistema split consta de unidad exterior, unidad interior, compresor, serpentines, ventiladores y controles. Realizamos diagnóstico y reparación integral.</p>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Manejamos pruebas de hermeticidad, vacío y carga, asegurando eficiencia y confiabilidad.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Servicio con repuestos originales conforme a fabricante.</p>
            </div>
          </div>
        </div>
      </div>
...
export default SplitAireAcondicionado;
