...
const InstalacionDeCuartosFrios = () => {
  return (
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre InstalacionDeCuartosFrios.';
...
export default InstalacionDeCuartosFrios;
