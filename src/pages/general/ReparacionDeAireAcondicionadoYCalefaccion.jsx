...
const ReparacionDeAireAcondicionadoYCalefaccion = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="absolute inset-0">
          <img 
            src={heroImg} 
            alt="ReparacionDeAireAcondicionadoYCalefaccion" 
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">
            ReparacionDeAireAcondicionadoYCalefaccion
          </h1>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre ReparacionDeAireAcondicionadoYCalefaccion.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              ...
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="text-gray-700 space-y-4">
                 ...
                 <p className="text-sm">
                   Utilizamos instrumentos de diagnóstico para una reparación precisa y durable.
                 </p>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="text-gray-700 space-y-4">
                 <p>
                   Planes para maximizar eficiencia y vida útil:
                 </p>
                 <ul className="list-disc list-inside space-y-2 text-sm">
          ...
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Un sistema de aire acondicionado central está compuesto por unidad condensadora, unidad manejadora de aire, compresor, serpentines, ventiladores, termostatos, tableros de control, válvula de expansión y red de ductos.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Ofrecemos diagnóstico y reparación de fallas como baja capacidad de enfriamiento, ruidos, fugas de refrigerante, fallos eléctricos, motores dañados, serpentines sucios y problemas de drenaje por condensados.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Servicio técnico con repuestos originales, pruebas de hermeticidad, vacío y carga de refrigerante según especificación del fabricante.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-600">Instrumentación profesional para causa raíz.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Especialistas en sistemas residenciales y comerciales.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-600">Respaldo en nuestras intervenciones.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default ReparacionDeAireAcondicionadoYCalefaccion;
