...
const ParaArreglarAireAcondicionado = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="absolute inset-0">
          <img 
            src={heroImg} 
            alt="ParaArreglarAireAcondicionado" 
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre ParaArreglarAireAcondicionado.';
...
export default ParaArreglarAireAcondicionado;
