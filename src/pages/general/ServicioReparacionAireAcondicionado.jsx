...
const ServicioReparacionAireAcondicionado = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="absolute inset-0">
          <img 
            src={heroImg} 
            alt="ServicioReparacionAireAcondicionado" 
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">
            ServicioReparacionAireAcondicionado
          </h1>
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">
            Servicio profesional de reparación de aire acondicionado
          </p>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre ServicioReparacionAireAcondicionado.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              ...
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="text-gray-700 space-y-4">
                 <p>
                   Solucionamos fallas de enfriamiento, ruidos, fugas y problemas eléctricos.
                 </p>
                 <ul className="list-disc list-inside space-y-2 text-sm">
                   <li>Reparación de fugas y recarga de refrigerante</li>
                   <li>Reparación de tarjetas y sensores</li>
                   <li>Cambio de compresor y ventiladores</li>
                   <li>Limpieza profunda de serpentines</li>
                 </ul>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               <div className="text-center mb-6">
                 ...
                 <h3 className="text-2xl font-bold text-gray-800 mb-4">Servicio Garantizado</h3>
               </div>
               <div className="text-gray-700 space-y-4">
                 <p>
                   Técnicos certificados y repuestos originales para mayor durabilidad.
                 </p>
               </div>
             </div>
          ...
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Reparamos equipos residenciales y comerciales con enfoque en eficiencia y confiabilidad.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Agenda tu servicio para recuperar el confort de tus espacios.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-600">Instrumentación profesional y protocolos estandarizados.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Experiencia en marcas y modelos variados.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default ServicioReparacionAireAcondicionado;
