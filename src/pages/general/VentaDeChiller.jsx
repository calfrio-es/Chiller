...
const VentaDeChiller = () => {
  const h1Text = 'Venta De Chiller';
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">Venta, asesoría e instalación de chillers</p>
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Asesoría Técnica</h3>
                </div>
                <div className="text-gray-700 space-y-4">
                  <p>Te ayudamos a elegir el chiller adecuado para tu proyecto.</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Cálculo de capacidad</li>
                    <li>Evaluación energética</li>
                    <li>Configuración del sistema</li>
                    <li>Plan de instalación</li>
                  </ul>
                </div>
              </div>
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Instalación profesional y pruebas de rendimiento.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Equipos de marcas reconocidas, soporte y garantía.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Proyectos llave en mano y servicio postventa.</p>
            </div>
          </div>
        </div>
      </div>
