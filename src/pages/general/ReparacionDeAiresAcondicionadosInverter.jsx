...
const ReparacionDeAiresAcondicionadosInverter = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        <div className="absolute inset-0">
          <img src={heroImg} alt="ReparacionDeAiresAcondicionadosInverter" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">ReparacionDeAiresAcondicionadosInverter</h1>
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre ReparacionDeAiresAcondicionadosInverter.';
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-lg text_gray-700 leading-relaxed">Nuestro servicio técnico especializado asegura una intervención rápida y efectiva, con repuestos originales, pruebas de hermeticidad, vacío y carga de refrigerante según especificación del fabricante.</p>
            </div>
          </div>
        </div>
      </div>
...
export default ReparacionDeAiresAcondicionadosInverter;
