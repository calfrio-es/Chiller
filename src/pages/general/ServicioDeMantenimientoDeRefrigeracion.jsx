...
const ServicioDeMantenimientoDeRefrigeracion = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="absolute inset-0">
          <img 
            src={heroImg} 
            alt="ServicioDeMantenimientoDeRefrigeracion" 
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">
            ServicioDeMantenimientoDeRefrigeracion
          </h1>
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">
            Servicio técnico especializado en mantenimiento de sistemas de refrigeración
          </p>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre ServicioDeMantenimientoDeRefrigeracion.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              ...
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="text-gray-700 space-y-4">
                 <p>
                   Mantenimiento preventivo y correctivo para cuartos fríos, vitrinas, neveras industriales y sistemas de refrigeración comercial.
                 </p>
                 <ul className="list-disc list-inside space-y-2 text-sm">
                   <li>Limpieza de serpentines y condensadores</li>
                   <li>Verificación de presiones y carga de refrigerante</li>
                   <li>Chequeo eléctrico y protecciones</li>
                   <li>Revisión de fugas y hermeticidad</li>
                   <li>Calibración de termostatos y controladores</li>
                 </ul>
                 <p className="text-sm">
                   Optimizamos el rendimiento y reducimos el consumo energético, alargando la vida útil del equipo.
                 </p>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="text-gray-700 space-y-4">
                 <p>
                   Respuesta rápida para evitar pérdidas de producto y tiempos de inactividad.
                 </p>
                 <ul className="list-disc list-inside space-y-2 text-sm">
                   <li>Atención de emergencias</li>
                   <li>Diagnóstico con instrumentación profesional</li>
                   <li>Repuestos originales</li>
                 </ul>
                 <p className="text-sm">
                   Servicio confiable y garantizado para tu operación comercial.
                 </p>
               </div>
             </div>
          ...
          <div className="relative z-10">
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">
                Servicio de Mantenimiento de Refrigeración Comercial
              </h2>
            </div>

            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Ofrecemos mantenimiento especializado para sistemas de refrigeración comercial e industrial, manteniendo temperaturas estables y operación continua.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Implementamos rutinas de limpieza, ajustes eléctricos, revisión de fugas y calibración de controles para prevenir fallas y mejorar la eficiencia.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Agenda tu mantenimiento y evita paradas inesperadas, protegiendo tus productos y tu negocio.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-600">Instrumentación profesional y experiencia en refrigeración comercial.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Especialistas en cuartos fríos, vitrinas y equipos de conservación.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Compatibilidad y durabilidad garantizadas por fabricante.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Menos paradas, más continuidad para tu operación.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600">Ajustes y calibraciones para menor consumo.</p>
            </div>
          </div>
        </div>
      </div>
...
export default ServicioDeMantenimientoDeRefrigeracion;
