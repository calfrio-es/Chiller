...
const ReparacionDeChillers = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        <div className="absolute inset-0">
          <img src={heroImg} alt="ReparacionDeChillers" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">ReparacionDeChillers</h1>
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre ReparacionDeChillers.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Fallas en chillers enfriados por aire y agua:</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Fugas de refrigerante y reparación de líneas</li>
                    <li>Cambio de compresor, ventiladores y bombas</li>
                    <li>Reparación de tableros, sensores y contactores</li>
                    <li>Limpieza de serpentines e intercambiadores</li>
                    <li>Corrección de drenajes y purga de aire</li>
                  </ul>
                </div>
              </div>
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Planes para estabilidad operativa y eficiencia energética:</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Inspección, limpieza y ajuste periódico</li>
                    <li>Verificación de presiones y vacío</li>
                    <li>Chequeo eléctrico y protecciones</li>
                    <li>Calibración de controles y setpoints</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            <div className="mb-8"><h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">Reparación de Chiller</h2></div>
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Atendemos sistemas con compresores scroll, screw y centrífugos, manejando protocolos de vacío, hermeticidad y carga de refrigerante.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Optimizamos rendimiento y consumo mediante mantenimiento planificado y repuestos originales.</p>
            </div>
          </div>
        </div>
      </div>
...
export default ReparacionDeChillers;
