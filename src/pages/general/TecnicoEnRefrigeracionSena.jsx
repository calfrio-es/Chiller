...
const TecnicoEnRefrigeracionSena = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Tecnico En Refrigeracion Sena" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">Tecnico En Refrigeracion Sena</h1>
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">Técnico en refrigeración - SENA</p>
          <div className="flex justify-center mt-8">
            <button
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre Tecnico En Refrigeracion Sena.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Formación Técnica</h3>
                </div>
                <div className="text-gray-700 space-y-4">
                  <p>Aplicación de buenas prácticas de mantenimiento:</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Limpieza, ajustes y verificaciones</li>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Servicio Técnico</h3>
                </div>
                <div className="text-gray-700 space-y-4">
                  <p>Atención de fallas y puesta a punto en equipos de refrigeración.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            <div className="mb-8"><h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">Técnico en Refrigeración SENA</h2></div>
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Atención profesional con formación SENA, procedimientos estandarizados y garantía por escrito.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Repuestos originales y buenas prácticas del sector.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300"><div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center"><svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><h3 className="text-lg font-semibold text-gray-800 mb-2">Técnicos certificados</h3><p className="text-sm text-gray-600">Formación y experiencia comprobada.</p></div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duración-300"><div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center"><svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7h18M8 7v10m8-10v10M5 21h14" /></svg></div><h3 className="text-lg font-semibold text-gray-800 mb-2">Repuestos originales</h3><p className="text-sm text_gray-600">Compatibilidad y durabilidad.</p></div>
...
export default TecnicoEnRefrigeracionSena;
