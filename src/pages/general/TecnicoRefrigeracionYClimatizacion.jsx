...
const TecnicoRefrigeracionYClimatizacion = () => {
  const h1Text = 'Tecnico Refrigeracion Y Climatizacion';
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">Refrigeración y climatización profesional</p>
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Atención para sistemas de refrigeración y climatización.</p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Rutinas de mantenimiento para optimizar consumo y rendimiento.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            <div className="mb-8"><h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">Técnico Refrigeración y Climatización</h2></div>
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Servicio integral para equipos residenciales y comerciales.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Garantía por escrito y repuestos originales.</p>
            </div>
          </div>
        </div>
      </div>
...
export default TecnicoRefrigeracionYClimatizacion;
