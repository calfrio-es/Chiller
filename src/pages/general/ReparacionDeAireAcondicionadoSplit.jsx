...
const ReparacionDeAireAcondicionadoSplit = () => {
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        <div className="absolute inset-0">
          <img src={heroImg} alt="ReparacionDeAireAcondicionadoSplit" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-bold text-white mb-4 drop-shadow-lg">ReparacionDeAireAcondicionadoSplit</h1>
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre ReparacionDeAireAcondicionadoSplit.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Atendemos fallas frecuentes y complejas en sistemas centrales:</p>
                  ...
                  <p className="text-sm">Utilizamos instrumentos de diagnóstico (pinza amperimétrica, manómetros, vacuómetro) para una reparación precisa y durable.</p>
                </div>
              </div>
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Planes de mantenimiento para maximizar eficiencia y vida útil:</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                  ...
                  <p className="text-sm">Reducimos fallas imprevistas y consumo energético, manteniendo el confort y continuidad operativa.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            <div className="mb-8"><h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">Reparación de Aire Acondicionado Central</h2></div>
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Un sistema de aire acondicionado central está compuesto por unidad condensadora, unidad manejadora de aire, compresor, serpentines (condensador y evaporador), ventiladores, termostatos, tableros de control, válvula de expansión y red de ductos.</p>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Ofrecemos diagnóstico y reparación de fallas como baja capacidad de enfriamiento, ruidos o vibraciones, fugas de refrigerante, sobreconsumo energético, fallos eléctricos, motores dañados, serpentines sucios u obstruidos y problemas de drenaje por condensados.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Nuestro servicio técnico especializado asegura una intervención rápida y efectiva, con repuestos originales, pruebas de hermeticidad, vacío y carga de refrigerante según especificación del fabricante.</p>
            </div>
          </div>
        </div>
      </div>
...
export default ReparacionDeAireAcondicionadoSplit;
