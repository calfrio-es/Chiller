          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre MantenimientoDeChiller.';
...
export default MantenimientoDeChiller;
