...
const TecnicosParaRepararAireAcondicionado = () => {
  const h1Text = 'Tecnicos Para Reparar Aire Acondicionado';
  return (
    <div className="min-h-screen bg-blue-50">
      <section className="relative h-120 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">Atención rápida y garantizada</p>
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Reparaciones con garantía y repuestos originales.</p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Fugas y recargas</li>
                    <li>Placas, sensores y ventiladores</li>
                    <li>Limpieza de evaporador y condensador</li>
                    <li>Chequeo eléctrico</li>
                  </ul>
                </div>
              </div>
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>Rutinas de mantenimiento para prevenir fallas.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">Disponibilidad local, atención rápida y garantía por escrito.</p>
              <p className="text-lg text-gray-700 leading-relaxed">Trabajamos con insumos de calidad y protocolos técnicos.</p>
            </div>
          </div>
        </div>
      </div>
...
export default TecnicosParaRepararAireAcondicionado;
