          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, necesito información sobre Reparacion Chiller.';
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              ...
              <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="text-gray-700 space-y-4">
                 <p>
                   Fallas en chillers enfriados por aire y agua:
                 </p>
             ...
             <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="text-gray-700 space-y-4">
                 <p>
                   Planes para estabilidad operativa y eficiencia energética:
                 </p>
                 <ul className="list-disc list-inside space-y-2 text-sm">
          ...
          <div className="relative z-10">
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">
                Reparación de Chiller
              </h2>
            </div>

            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Atendemos sistemas con compresores scroll, screw y centrífugos, manejando protocolos de vacío, hermeticidad y carga de refrigerante.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Optimizamos rendimiento y consumo mediante mantenimiento planificado y repuestos originales.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-600">Especialistas en chillers de diversas marcas.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="w-12 h-12 mb-4 bg-blue-100 rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
