...
const ProductoEspecifico = () => {
      ...
      <div className="min-h-screen bg-white pt-20">
        <div className="container mx-auto px-4 py-6">
          <div className="text-center">
            ...
            <Link to="/chiller" className="text-[#2b9b8d] hover:text-[#1a7a6f]">
              Volver al catálogo
            </Link>
          </div>
        </div>
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = `Hola, me gustaría cotizar el ${producto.nombre}.`;
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <nav className="text-sm text-gray-600">
            <Link to="/inicio" className="hover:text-[#2b9b8d]">Inicio</Link>
            <span className="mx-2">/</span>
            <Link to="/chiller" className="hover:text-[#2b9b8d]">Chiller</Link>
            <span className="mx-2">/</span>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600">
                Modelo: {producto.modelo} | Marca: {producto.marca}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                {producto.descripcion} es un sistema de refrigeración industrial de alta calidad, 
                diseñado para proporcionar enfriamiento eficiente y confiable para aplicaciones comerciales e industriales. 
                Este equipo ofrece un rendimiento excepcional con bajo consumo energético y mantenimiento simplificado.
              </p>
              <button className="text-[#2b9b8d] hover:text-[#1a7a6f] underline mt-2">
                Ver más...
              </button>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-center">
                <Thermometer className="w-5 h-5 mr-2 text-[#2b9b8d]" />
            ...
            <div className="flex justify-center pt-6">
              <button
                ...
                className="px-8 py-3 text-white rounded-lg font-semibold text-sm transition-colors flex items-center justify-center"
                style={{ backgroundColor: '#2b9b8d' }}
                onMouseOver={(e) => e.target.style.backgroundColor = '#1a7a6f'}
                onMouseOut={(e) => e.target.style.backgroundColor = '#2b9b8d'}
              >
