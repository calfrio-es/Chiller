...
import chillerImage from "../../assets/img/chiller5toneladas.jpg"
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
                ...
                Chiller 5 Toneladas: Soluciones Compactas y Eficientes para Refrigeración Industrial y Comercial
              </h2>
              <img src={chillerImage} alt="Chiller 5 Toneladas" className="w-full rounded-xl shadow-lg mb-8" />
              <p className="text-gray-700 text-lg leading-relaxed">
                En el mundo de la climatización y refrigeración, elegir el sistema adecuado marca una gran diferencia en términos de eficiencia energética, durabilidad y costos operativos. El chiller 5TR (equivalente a chiller 5 toneladas) es una solución intermedia ideal para proyectos comerciales, industriales ligeros y aplicaciones especializadas que requieren enfriamiento continuo sin sobredimensionar el sistema.
              </p>
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
                ...
                Características Técnicas del Chiller 5 Toneladas
              </h2>
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                Los chillers 5 toneladas están disponibles en versiones enfriadas por aire o por agua, dependiendo del entorno de operación y necesidades específicas del cliente. En general, estos equipos cuentan con:
              </p>
              <ul className="space-y-2 text-gray-700 text-lg">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 mr-3 text-green-500 mt-1 flex-shrink-0" />
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
                ...
                Aplicaciones Típicas del Chiller 5TR
              </h2>
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                La versatilidad del chiller 5TR lo convierte en una excelente opción para instalaciones medianas donde se requiere una fuente constante de agua fría. Algunas aplicaciones comunes incluyen:
              </p>
              <ul className="space-y-2 text-gray-700 text-lg">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 mr-3 text-green-500 mt-1 flex-shrink-0" />
              ...
              <p className="text-gray-700 text-lg leading-relaxed mt-4">
                En todos estos casos, el chiller 5 toneladas permite mantener un control preciso de la temperatura, mejorar la eficiencia de los procesos y proteger los activos técnicos de la empresa.
              </p>
            </div>
            ...
            <div className="rounded-2xl p-8 text-center text-white" style={{ background: 'linear-gradient(to right, #2b9b8d, #1a7a6f)' }}>
              <h2 className="text-3xl font-bold mb-4">Cotiza Hoy tu Chiller 5 Toneladas con los Mejores del Mercado</h2>
              <p className="text-xl mb-8 opacity-90">
                ¿Buscas un chiller 5 toneladas confiable, eficiente y al mejor precio? Nosotros tenemos la solución que necesitas, con opciones de financiamiento, garantía y soporte técnico especializado.
              </p>
              ...
              <div className="flex justify-center">
                <button 
                  ...
                  onClick={() => {
                    ...
                    const message = 'Hola, me gustaría solicitar una cotización para el Chiller Alpunto 5 Toneladas.';
