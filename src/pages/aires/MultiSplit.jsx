      ...
      <section className="relative h-96 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">
            Venta, Reparación y Mantenimiento de Sistemas Multi Split
          </p>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, me gustaría obtener información sobre servicios de sistemas Multi Split.';
          ...
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                La gran ventaja de un MultiSplit es que se logra la climatización de todo el hogar o de espacios grandes, mediante diferentes unidades interiores que están integradas en una sola unidad exterior.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Para este tipo de aires acondicionados le ofrecemos el mejor servicio de instalación, con nuestro equipo de profesionales especialistas, quienes le garantizarán que todas las unidades funcionen correctamente.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Nuestro equipo de especialistas en aire acondicionado multi split, realiza montaje y desmontaje del artefacto, para realizarle el mantenimiento completo.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Le realizamos mantenimiento de aire acondicionado multi split, de cualquier marca, BTU y voltaje.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Le realizamos mantenimiento, limpieza, reparación e instalación de aire acondicionado multi split, de marca LG, Samsung, Electrolux, Bosch, Toshiba y Whirlpool.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Mini Split, Piso Techo y Diseño Especializado
            </h2>
            
            <p className="text-gray-500 text-base max-w-3xl mx-auto">
              Además de Multi Split, ofrecemos soluciones completas para diferentes necesidades de climatización, incluyendo sistemas Mini Split, equipos Piso Techo y servicios de diseño y cálculo especializado.
            </p>
          </div>

          {/* Main Content - Services Column */}
          <div className="space-y-6 max-w-6xl mx-auto">
            <Link to="/mini-split" className="block">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-6">
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-6 flex-1">
                    ...
                    <p className="text-sm lg:flex-1 text-gray-700">
                      Sistemas Mini Split para climatización individual de espacios. Ideal para habitaciones, oficinas pequeñas y áreas que requieren control de temperatura independiente con máxima eficiencia energética.
                    </p>
                  </div>
