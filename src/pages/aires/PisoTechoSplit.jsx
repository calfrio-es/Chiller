      ...
      <section className="relative h-96 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">
            Mantenimiento Aires Acondicionados Piso Techo
          </p>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, me gustaría obtener información sobre servicios de mantenimiento de aires acondicionados piso techo.';
          ...
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Por ser este un artefacto ideal para oficinas, gracias a su capacidad y eficiencia en el flujo de aire, ofrecemos a todos nuestros clientes el mejor servicio de Mantenimiento de Aires Acondicionados de Techo LG del país, con el que ese espacio laboral en el que probablemente hacen vida muchas personas, se podrá mantener con un clima de calidad como nuestro servicios.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Nuestro equipo de técnicos especializados cuenta con la experiencia y herramientas necesarias para diagnosticar y resolver cualquier problema que pueda presentar su sistema de aire acondicionado Piso Techo, garantizando un servicio rápido y eficiente.
              </p>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Mini Split, Multi Split y Diseño Especializado
            </h2>
            
            <p className="text-gray-500 text-base max-w-3xl mx-auto">
              Además de Piso Techo, ofrecemos soluciones completas para diferentes necesidades de climatización, incluyendo sistemas Mini Split, Multi Split y servicios de diseño y cálculo especializado.
            </p>
          </div>
