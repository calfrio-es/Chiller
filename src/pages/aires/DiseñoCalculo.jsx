      ...
      <section className="relative h-96 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">
            Servicios Especializados de Diseño y Cálculo de Aires Acondicionados
          </p>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, me gustaría obtener información sobre servicios de diseño y cálculo de aires acondicionados.';
          ...
          <div className="relative z-10">
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">
                Diseño y Cálculo de Aires Acondicionados
              </h2>
            </div>

            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Nuestro departamento de ingeniería y diseño trabaja sobre planos básicos suministrados por nuestros clientes, desarrollando el diseño apropiado para cubrir su requerimiento.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Contamos con un equipo de ingenieros especializados en sistemas de climatización que realizan análisis térmicos detallados, cálculo de cargas térmicas y selección optimizada de equipos para garantizar la máxima eficiencia energética.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Ofrecemos servicios completos de diseño, incluyendo planos técnicos, especificaciones de equipos, cálculo de ductos y asesoría especializada para proyectos residenciales, comerciales e industriales.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Mini Split, Multi Split y Piso Techo Especializado
            </h2>
            
            <p className="text-gray-500 text-base max-w-3xl mx-auto">
              Además de diseño y cálculo, ofrecemos soluciones completas para diferentes necesidades de climatización, incluyendo sistemas Mini Split, Multi Split y equipos Piso Techo con instalación y mantenimiento especializado.
            </p>
          </div>
