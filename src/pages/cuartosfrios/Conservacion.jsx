...
import heroConservacionImg from '../../assets/img/layout/heroconservacion.jpg';
    ...
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="relative h-96 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="absolute inset-0">
          <img 
            src={heroConservacionImg} 
            alt="Sistema de conservación industrial" 
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, me gustaría obtener información sobre servicios de conservación industrial.';
          ...
          <div className="relative z-10">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Siempre que se piensa en conservación, también se piensa en cuartos fríos porque para nadie es un secreto que este tipo de sistemas de refrigeración o enfriamiento son los que hacen más lentos los procesos químicos y biológicos de ciertos alimentos, controlando su pronto deterioro y la pérdida de calidad.
              </p>
