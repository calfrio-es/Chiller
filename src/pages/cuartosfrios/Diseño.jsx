...
import heroDiseñoImg from '../../assets/img/layout/herodiseño.jpg';
    ...
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="relative h-96 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="absolute inset-0">
          <img 
            src={heroDiseñoImg} 
            alt="Diseño de cuartos fríos industrial" 
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">
            Diseño y soluciones a medida de Cuartos Fríos Industriales
          </p>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, me gustaría obtener información sobre servicios de diseño de cuartos fríos.';
          ...
          <div className="relative z-10">
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">
                Diseño y Soluciones a Medida De Cuartos Frios
              </h2>
            </div>

            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Nuestro departamento de ingeniería y diseño trabaja sobre planos básicos suministrados por nuestros clientes, desarrollando el diseño apropiado para cubrir su requerimiento. Aquí siempre consideramos los siguientes aspectos:
              </p>
              
              <ul className="list-disc list-inside space-y-3 text-lg text-gray-700 leading-relaxed">
                <li>Elegir los mejores equipos, de calidad y a bajos costos.</li>
                <li>Elegir la mejor ubicación de acceso para el personal, que esta sea totalmente segura para los empleados.</li>
                <li>Elegir la eficiencia energética más conveniente que se debe utilizar.</li>
              </ul>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 relative">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Congelación Industrial</h3>
                </div>
                <div className="text-gray-700 space-y-4">
                  <p>
                    Especialistas en sistemas de congelación que preservan la calidad y frescura de sus productos:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>Control preciso de temperatura</li>
                    <li>Humedad relativa optimizada</li>
                  ...
                  <p className="text-sm">
                    Garantizamos la congelación óptima de alimentos, medicamentos y productos sensibles a la temperatura.
                  </p>
                </div>
              </div>
