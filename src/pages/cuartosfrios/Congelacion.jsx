      ...
      <section className="relative h-96 w-full overflow-hidden flex items-center justify-center pt-18">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-6 drop-shadow-md">
            Venta, Reparación y Mantenimiento de Equipos Industriales
          </p>
          ...
          <div className="flex justify-center mt-8">
            <button 
              ...
              onClick={() => {
                ...
                const message = 'Hola, me gustaría obtener información sobre servicios de congelación industrial.';
          ...
          <div className="relative z-10">
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 leading-tight">
                Mantenimiento De Congelación
              </h2>
            </div>

            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                El sistema de Congelación está compuesto por un compresor, un condensador, un evaporador, un filtro decantador, una válvula de expansión y un presostato.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Un Cuarto de congelación es un lugar determinado para la recepción de mercancía, productos frescos y no elaborados que posteriormente pudiesen ser distribuidos a las distintas neveras, siendo el acondicionamiento y el mantenimiento de estos cuartos uno de los aspectos más importantes para nuestra empresa.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Es por eso que ofrecemos a nuestros clientes no solo la instalación adecuada sino el mejor servicio de mantenimiento o reparación para mantener o restablecer la operatividad efectiva de su espacio.
              </p>
            </div>
          </div>
          ...
          <div className="w-full">
               ...
               <div className="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-gray-700 space-y-4">
                  <p>
                    Diseñamos cuartos de congelación personalizados según sus necesidades específicas, considerando:
                  </p>
                  ...
                  <p className="text-sm">
                    Nuestro equipo de ingenieros especializados garantiza un diseño óptimo que maximice la eficiencia y durabilidad.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Conservación Industrial</h3>
                </div>
                <div className="text-gray-700 space-y-4">
                  <p>
                    Especialistas en sistemas de conservación que mantienen la calidad y frescura de sus productos:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-sm">
                  ...
                  <p className="text-sm">
                    Garantizamos la preservación óptima de alimentos, medicamentos y productos sensibles a la temperatura.
                  </p>
                </div>
              </div>
